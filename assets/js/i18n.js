...
const o = {
  "pt-BR": {
    meta: {
      ...
      description:
        "Portfólio de Leandro — Desenvolvedor Full Stack. Projetos, arquitetura limpa e segurança em foco.",
    },
    nav: {
      aria: "Principal",
    ...
    solar: {
      ...
      summary:
        "Domínios técnicos orbitando um centro de entrega, automação e operação.",
      statusTitle: "Automação e análise com código claro.",
      statusDescription:
        "Scripts, integrações e rotinas confiáveis para operação real.",
      interactionHint:
        "Clique em um planeta ou use as setas do teclado para navegar pela cena.",
      ...
      stageLabel:
        "Cena 3D do Sistema Solar Profissional. Clique em um planeta ou use as setas para alternar domínios.",
      python: "Python",
      sql: "SQL",
    ...
    hero: {
      ...
      subtitle:
        "Desenvolvedor Full Stack focado em construir interfaces fluidas, arquiteturas limpas e experiências digitais com a sutileza de um produto premium.",
      ...
      codeLabel:
        "Editor de código digitando um snippet que descreve o desenvolvedor.",
    },
    about: {
      eyebrow: "Sobre mim",
      title:
        'Construindo software com <span class="text-accent">propósito</span>.',
    ...
    architecture: {
      eyebrow: "Arquitetura",
      title:
        'Sistemas pensados para <span class="text-accent">escalar</span> e durar.',
    ...
    security: {
      eyebrow: "Segurança",
      title:
        'Segurança não é feature. <br />É <span class="text-accent">fundação</span>.',
    ...
    ai: {
      ...
      reset: "Nova conversa",
      initial:
        "Pergunte sobre minhas habilidades, projetos, experiência ou como posso ajudar no seu produto.",
  ...
  "en-US": {
    meta: {
      ...
      description:
        "Leandro's portfolio — Full Stack Developer. Projects, clean architecture, and security in focus.",
    },
    nav: {
      aria: "Main",
      home: "Back to top",
    ...
    solar: {
      ...
      summary:
        "Technical domains orbiting a delivery, automation, and operations core.",
      statusTitle: "Automation and analysis with clear code.",
      statusDescription:
        "Reliable scripts, integrations, and routines for real operations.",
      interactionHint:
        "Click a planet or use the keyboard arrow keys to navigate the scene.",
      ...
      next: "Next planet",
      stageLabel:
        "3D scene of the Professional Solar System. Click a planet or use arrow keys to switch domains.",
      python: "Python",
      sql: "SQL",
      javascript: "JavaScript",
    ...
    hero: {
      ...
      subtitle:
        "Full Stack Developer focused on building fluid interfaces, clean architectures, and digital experiences with the subtlety of a premium product.",
    ...
    architecture: {
      ...
      title:
        'Systems designed to <span class="text-accent">scale</span> and last.',
    ...
    security: {
      eyebrow: "Security",
      title:
        'Security is not a feature. <br />It is the <span class="text-accent">foundation</span>.',
    ...
    ai: {
      ...
      initial:
        "Ask about my skills, projects, experience, or how I can help with your product.",
      ...
      answerError:
        "I could not generate an answer right now. Try again in a moment.",
    ...
    contact: {
      ...
      emailDomainNotAllowed:
        "Use a personal email from an accepted provider, such as @gmail.com, @outlook.com, or @icloud.com.",
  ...
  ((r = LANGUAGES.includes(o) ? o : a),
    ...
    (function (e = document) {
      (e.querySelectorAll("[data-i18n]").forEach((e) => {
        ...
        e.querySelectorAll("[data-i18n-html]").forEach((e) => {
          e.innerHTML = t(e.dataset.i18nHtml);
        }),
        e.querySelectorAll("[data-i18n-attr]").forEach((e) => {
          e.dataset.i18nAttr.split(";").forEach((a) => {
            const [o, r] = a.split(":").map((e) => e?.trim());
            o && r && e.setAttribute(o, t(r));
          });
        }));
    })(),
    document.querySelectorAll("[data-language-option]").forEach((e) => {
      const a = e.dataset.languageOption === r;
...
export function initI18n() {
  ((r = (function () {
    try {
      ...
      return LANGUAGES.includes(o) ? o : a;
    } catch {
      return a;
    }
  })()),
    applyLanguage(r, { persist: !1, notify: !1 }),
    document.querySelectorAll("[data-language-option]").forEach((e) => {
      e.addEventListener("click", () =>
        applyLanguage(e.dataset.languageOption),
      );
    }));
}
